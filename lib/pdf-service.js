...
export async function generateTicketPDF({ fullName, ticketType, ticketId }) {
    ...
    try {
        ...
        page.drawText('TICKET ID', { x: 20, y: height - 210, size: 8, font: helvetica, color: rgb(1, 0.55, 0) });
        page.drawText(ticketId, { x: 20, y: height - 230, size: 14, font: helveticaBold, color: rgb(1, 1, 1) });
